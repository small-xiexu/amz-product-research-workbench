...
- 每个 VOC 痛点必须映射到至少一个具体产品规格或供应商验证动作；无法映射时必须标注“待转化为产品规格”
...
3. **是否已转成规格**：必须写出材料、结构、尺寸、工艺、包装、配件、测试指标或供应商问询项；只写“质量更好”“体验优化”视为未完成
...
- **产品方案**：如果要解决「[痛点]」，具体方案是……
- **规格/供应商验证动作**：「[痛点]」→ 要求供应商验证 [材料/结构/尺寸/工艺/包装/配件/测试指标]；无法映射时写“待转化为产品规格：缺 [证据/样品/供应商信息]”
...
6. **痛点必须落规格**：不能只列“腰带松”“扣具差”“尺寸不合适”；必须写成“痛点 → 产品能力 → 规格/供应商验证动作”，例如“扣具差 → 需要高强度快拆扣 → 询问供应商扣具材质、拉力测试和 500 次开合寿命”
...
- [ ] 每个痛点维度都已映射到至少一个具体产品规格或供应商验证动作；无法映射的痛点已标注“待转化为产品规格”
- [ ] 好评卖点至少 2 个，有原文支撑
