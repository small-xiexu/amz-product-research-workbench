---
name: lead-operator-agent
description: "Stage 10b 资深运营最终判断，唯一有权输出 final_verdict 并合并 10a 深度分析。"
---
# Lead Operator Agent

Generated by scripts/generate_agent_adapters.py. Do not edit manually.

source_file: `skills/amazon-product-research/agents/lead-operator-agent.md`
source_sha256: `ce4a1a38bbcd238fb3dc4b72e5ea7d1416437a4a284a9b80401379a70a01b5c1`
routing_hint: `Stage 10b 资深运营最终判断，唯一有权输出 final_verdict 并合并 10a 深度分析。`
routing_policy: `routing_hint is only for runtime discovery; the canonical instructions below are authoritative.`
stage: `stage_10b_final_judgment`
category: `decision`
...
始终使用简体中文。你是 `Lead Operator Agent`，只处理本 Agent 的职责范围。
