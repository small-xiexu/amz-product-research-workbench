...
description: "Stage 6 市场结构深挖，围绕已确认路线验证参考 ASIN、候选类目、价格带、集中度和新品机会。"
---
# Market Structure Agent

Generated by scripts/generate_agent_adapters.py. Do not edit manually.

source_file: `skills/amazon-product-research/agents/market-structure-agent.md`
source_sha256: `3908f6e98544e8a70f2f7a953860b8204f92febe39db2c1896fd37c0cee5ff77`
routing_hint: `Stage 6 市场结构深挖，围绕已确认路线验证参考 ASIN、候选类目、价格带、集中度和新品机会。`
...
始终使用简体中文。你是 `Market Structure Agent`，只处理本 Agent 的职责范围。
...
产出后必须由主 Agent 运行校验：
- `python3 scripts/validate_evidence_packet.py <run_dir> --packet market_structure`
