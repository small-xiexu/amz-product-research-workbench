---
name: competition-evaluation-agent
description: "Stage 9 竞争结构评价，判断头部垄断、评论门槛和新品进入空间。"
---
# Competition Evaluation Agent

Generated by scripts/generate_agent_adapters.py. Do not edit manually.

source_file: `skills/amazon-product-research/agents/competition-evaluation-agent.md`
source_sha256: `84a792514dae0a95020358d87313ff00c378d2fae8d336cdf06c25b1ac33dc2a`
routing_hint: `Stage 9 竞争结构评价，判断头部垄断、评论门槛和新品进入空间。`
...
始终使用简体中文。你是 `Competition Evaluation Agent`，只处理本 Agent 的职责范围。
