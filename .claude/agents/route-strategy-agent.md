---
name: route-strategy-agent
description: "Stage 10a 供给端深度分析，输出路线推荐、路线取舍、竞品对标、竞品弱点和价格带解读。"
---
# Route Strategy Agent

Generated by scripts/generate_agent_adapters.py. Do not edit manually.

source_file: `skills/amazon-product-research/agents/route-strategy-agent.md`
source_sha256: `362f150e00ad46656f0743b25f175eaf03ef3c7f885832d6bc99da4ed585d6da`
routing_hint: `Stage 10a 供给端深度分析，输出路线推荐、路线取舍、竞品对标、竞品弱点和价格带解读。`
...
始终使用简体中文。你是 `Route Strategy Agent`，只处理本 Agent 的职责范围。
